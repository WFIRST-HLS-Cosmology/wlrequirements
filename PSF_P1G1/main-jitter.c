...
int main(int argc, char **argv) {
  ...
  if (argc<26) {
    fprintf(stderr, "Error -- too few arguments\nUsage: ./main.x pupil lambdamin lambdamax Nlam hexflags reff g1 g2 ZA0..ZA7 jitxx jitxy jityy Dx Dy alpha alpha+ ox oy\n");
    return(1);
  }
  ...
  sscanf(argv[24], "%lg", &ox);
  sscanf(argv[25], "%lg", &oy);
  ...
  for(ilam=0;ilam<Nlam;ilam++) for(Zflag=1;Zflag>-2;Zflag-=2) {
     ...
     */
    shift_phase_Z(A+l, 2, 0, ZA[0]*sqrt(3.)*Zflag, Rap);
    shift_phase_Z(A+l, 2, 2, ZA[1]*sqrt(6.)*Zflag, Rap);
    shift_phase_Z(A+l, 2,-2, ZA[2]*sqrt(6.)*Zflag, Rap);
    shift_phase_Z(A+l, 3, 1, ZA[3]*sqrt(8.)*Zflag, Rap);
    shift_phase_Z(A+l, 3,-1, ZA[4]*sqrt(8.)*Zflag, Rap);
    shift_phase_Z(A+l, 3, 3, ZA[5]*sqrt(8.)*Zflag, Rap);
    shift_phase_Z(A+l, 3,-3, ZA[6]*sqrt(8.)*Zflag, Rap);
    shift_phase_Z(A+l, 4, 0, ZA[7]*sqrt(5.)*Zflag, Rap);

    shift_phase_Z(A+l, 1, 1, Rap/INV_ARCSEC/1e3*ox*Zflag, Rap);
    shift_phase_Z(A+l, 1,-1, Rap/INV_ARCSEC/1e3*oy*Zflag, Rap);

    /* Static WFE for SCA1 */
#if 1
    shift_phase_Z(A+l, 2, 0, 0.05100918*1.292e-6*sqrt(3.), Rap);
    shift_phase_Z(A+l, 2,-2, 0.01311258*1.292e-6*sqrt(6.), Rap);
    shift_phase_Z(A+l, 2, 2,-0.01677499*1.292e-6*sqrt(6.), Rap);
    shift_phase_Z(A+l, 3,-1, 0.01003743*1.292e-6*sqrt(8.), Rap);
    shift_phase_Z(A+l, 3, 1,-0.00643873*1.292e-6*sqrt(8.), Rap);
    shift_phase_Z(A+l, 3,-3,-0.00594562*1.292e-6*sqrt(8.), Rap);
    shift_phase_Z(A+l, 3, 3, 0.00143172*1.292e-6*sqrt(8.), Rap);
    shift_phase_Z(A+l, 4, 0, 0.00052267*1.292e-6*sqrt(3.), Rap);
#endif
